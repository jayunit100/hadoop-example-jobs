 ...
 * <p>
 * To run the program: 
 * <b>bin/hadoop jar hadoop-*-examples.jar PetGen 10000000000 in-dir</b>
 */
public class PetGen extends Configured implements Tool {
  private static final Log LOG = LogFactory.getLog(PetGen.class);
  ...
  private static void usage() throws IOException {
    System.err.println("PetGen <num rows> <output dir>");
  }
  ...
  public int run(String[] args) 
    ...
    job.setJobName("PetGen");
    job.setJarByClass(PetGen.class);
  ...
  public static void main(String[] args) throws Exception {
    int res = ToolRunner.run(new Configuration(), new PetGen(), args);
    System.exit(res);
  }
}
